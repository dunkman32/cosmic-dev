...
export const data = [
  ...
  },
  {
    ...
    icon: asg,
    title: 'ASG',
    text: 'asg.ge provides full services for cleaning and access control management in buildings and residential apartments. Along with many other comfortable services you will be able to access your building, travel in the elevator with your personal card.',
    link: 'https://www.asg.ge/eng/',
  },
  {
    id: 4,
    icon: uncia,
